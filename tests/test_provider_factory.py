...
def test_create_agent_uses_explicit_provider_type(monkeypatch):
    ...
    openai_agent = providers.create_agent("p-openai", memory_file_path="m4", system_prompt="s4")
    zhipu_agent = providers.create_agent("p-zhipu", memory_file_path="m5", system_prompt="s5")
