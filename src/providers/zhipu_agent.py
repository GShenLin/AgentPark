...
class ZhipuAgent(ServiceHost, BaseAgent):
    def __init__(self, provider_id="zhipu", memory_file_path=None, system_prompt=None, internal_memory_enabled=True):
        super().__init__(
            provider_id,
